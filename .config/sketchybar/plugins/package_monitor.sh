...
mouse_entered() {
  sketchybar -m --set packages_total icon.highlight=on \
                                     label.highlight=on \
                --set packages_details drawing=on \
                --set packages background.drawing=on
}

mouse_exited() {
  sketchybar -m --set packages_total icon.highlight=off \
                                     label.highlight=off \
                --set packages_details drawing=off \
